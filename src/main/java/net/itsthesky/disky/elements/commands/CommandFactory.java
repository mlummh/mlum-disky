...
public class CommandFactory {
    ...
    public ArrayList<ChannelType> parsePlaces(String[] places) {
        ...
        for (String place : places) {
            ...
            } else if (net.itsthesky.disky.core.Utils.equalsAnyIgnoreCase(place, "dm", "pm", "direct message", "private message")) {
                types.add(ChannelType.PRIVATE);
            } else if (net.itsthesky.disky.core.Utils.equalsAnyIgnoreCase(place, "thread", "threads")) {
                types.addAll(Arrays.asList(ChannelType.GUILD_PUBLIC_THREAD, ChannelType.GUILD_PRIVATE_THREAD));
            } else if (net.itsthesky.disky.core.Utils.equalsAnyIgnoreCase(place, "voice")) {
